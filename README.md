...
Currently, zozz is meant for Zig 0.14.0, but I'm sure it will move forward to more recent versions of Zig in the near future whenever I move the rest of my projects forward... It shouldn't be a big deal at all. This is probably going to stay tiny.

There is now a small graphical integration sample that uses `zglfw + zgpu + zmath` through `build.zig.zon` package dependencies and draws the animated skeleton as debug lines:
